...
export default tseslint.config(
    {
        ...
        ignores: [
            ...
            '.github/**',   // skill scripts (plain JS), not part of the tsconfig program
        ],
    },
...

    {
        ...
        rules: {
            ...
            'eqeqeq': ['error', 'always', { null: 'ignore' }], // `!= null` intentionally matches null and undefined
            'prefer-const': 'error',
        },
    },
    ...
    {
        // CustomReporter loads the optional AI modules via require() so a missing
        // src/ai directory degrades the report instead of failing the build.
        files: ['src/utils/CustomReporter.ts'],
        rules: {
